...
%Kein Abstand unter / Ã¼ber Bildern
...
%code
\usepackage{listings} \lstset{numbers=left, basicstyle=\tiny, numberstyle=\tiny, numbersep=5pt} \lstset{language=Perl}
...
\begin{center}
	...
	Bericht von\\
	\textbf{Andreas Knöpfle (281087)\\ Mathias Hodler (281159)}
...
\newpage
	...
	\section{Abkürzungsverzeichniss} 
		\begin{acronym}
 			...
 			\acro{plist}{Property Lists - speichern Einstellungen in Mac OS X}
		\end{acronym}
	\newpage		
	
		
	\section{Idee und Spielkonzept}
		\input{includes/01_IDEE_UND_SPIELKONZEPT}
		\newpage
	\section{Spezifikation}
		\input{includes/02_SPEZIFIKATION}	
		\newpage
	\section{Umsetzung}
		\input{includes/03-UMSETZUNG}	
		\newpage	
	\section{Lösung}
		\input{includes/04-LOESUNG}	
		\newpage		
